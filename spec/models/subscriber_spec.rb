...
describe Subscriber do
  ...
  describe '.create' do
    it 'has an id' do
      subscriber = Subscriber.create(tagline: 'yo', bio: 'wassup', gender: 'male', age: 22)
  ...
  describe '#metadata' do
    it 'has subscriber properties' do
      subscriber = Subscriber.create(tagline: 'hey', bio: 'my bio', preferences: 'a, b, c', bodytype: 'd', location: 'ny', status: 'single', ethnicity: 'human', gender: 'female', age: 29, occupation: 'rails dev', interests: 'a, b, c', political: 'independent', religion: 'i <3 God', education: 'GA', income: 1_000_000)
      ...
      expect(subscriber.religion).to eq 'i <3 God'
